...
game:GetService("ScriptInformationProvider"):SetAssetUrl("http://zomium.xyz/Asset/")
...
pcall(function() game:GetService("Players"):SetBuildUserPermissionsUrl("http://zomium.xyz//Game/BuildActionPermissionCheck.ashx?assetId=0&userId=%d&isSolo=true") end)
...
function doVisit()
	...
	player.CharacterAppearance = "http://zomium.xyz/Asset/CharacterFetch.ashx?userId={userid}&placeId=0"
