...
.catalog-shell { color: #f2f4f8; }
.catalog-title { font-size: 2rem; font-weight: 700; color: #fff; margin-bottom: 1.5rem; }
.catalog-panel, .catalog-search, .asset-card, .asset-thumb-container, .catalog-chip, #Paginator .form-control { background: #18181b !important; border: 1px solid rgba(255,255,255,.08) !important; }
.catalog-panel { border-radius: 0; overflow: hidden; background: #18181b !important; }
...
.catalog-search { border-radius: .35rem; overflow: hidden; }
.catalog-search .form-control, .catalog-search .btn { background: transparent !important; border: 0 !important; color: #eef2f6 !important; box-shadow: none !important; }
.catalog-search .form-control::placeholder { color: #8f97a3; }
.catalog-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 1.25rem; }
.asset-card { border-radius: .35rem; overflow: hidden; min-height: 100%; box-shadow: none !important; }
.asset-card-link { display: flex; flex-direction: column; min-height: 100%; color: inherit; text-decoration: none; }
.asset-thumb-container { position: relative; aspect-ratio: 1 / 1; overflow: hidden; border-bottom: 1px solid rgba(255,255,255,.08); padding: 1.35rem; display: flex; align-items: center; justify-content: center; }
	...
	<div class="card asset-card h-100 overflow-hidden">
		<a id="NameAndThumbs" href="javascript:void(0)" class="asset-card-link">
			<div class="asset-thumb-container">
				...
				<img class="img-fluid" src="/public/images/unavailable.jpg" alt="Asset thumb">
			</div>
...
<div class="py-4 catalog-shell" id="AssetsContainer">
