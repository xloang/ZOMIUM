...
<head>
    <?php
    $page_title = 'Places - Zomium';
    $page_scripts = ['/js/games.js?t=1771413807'];
    ...
    <style>
        ...
        .places-search .form-control::placeholder {
            color: #8f97a3;
        }
        ...
        .game-card a,
        .game-card .text-secondary,
        .game-card .text-muted,
        .inline-badge {
            color: #eef2f7 !important;
        }

        .game-card a:hover:not(.btn) {
...
<body>
    <div class="Game" template>
        <div class="card game-card h-100">
            <div class="game-thumb-container" id="ImageContainer">
                ...
                <img src="/thumbs/unavailable.jpg" alt="Game thumb">
            </div>
            <div class="card-body p-3">
                ...
                <div class="small text-secondary mb-2 text-truncate">
                    By <a href="" id="GameCreator" class="text-decoration-none">creator</a>
                </div>
    ...
    <main class="app-main py-4 places-shell" id="Games">
        <main class="app-main py-4 places-shell" id="Games">
    <div class="container">
        <h1 class="places-title"><?= htmlspecialchars($randomclientsplash, ENT_QUOTES, 'UTF-8') ?></h1>
...
<div class="col-lg-9">
    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
        <div class="download-btn" onclick="window.location.href='/download/2016/ANORRLPlayerLauncher.exe';">
            Download 2016 Client
        </div>
    </div>
...
<div id="StatusText" class="mb-4">
    ...
    <img src="/images/thinking.svg" alt="loading" style="width:250px;">
...
setTimeout(function () {
    ...
    document.getElementById("NoAssets").style.display = "block";
}, 15000); // 15 saniye
</script>
