...
<head>
    <?php $page_title = 'Admin Panel - Zomium';
                    ...
                    <div class="card admin-quick-card border-0 mb-4" id="search-panel">
                        <div class="card-body p-3">
                            ...
                            <form method="GET" class="d-grid gap-2">
                                <input class="form-control form-control-lg bg-dark text-light border-secondary"
                                    type="text" name="q" value="<?= htmlspecialchars($q, ENT_QUOTES, 'UTF-8') ?>"
                            ...
                            <div class="admin-quick-list d-grid gap-2">
                                <?php foreach ($recentUsers as $recentUser): ?>
                                    <a href="/admi?user_id=<?= $recentUser->id ?>">
                                        <span
                                            class="text-truncate"><?= htmlspecialchars($recentUser->name, ENT_QUOTES, 'UTF-8') ?></span>
                        ...
                        <div class="card admin-card border-0 mb-4 overflow-hidden" id="profile-summary">
                            <div class="card-body p-4">
                                <div class="d-flex gap-4 align-items-center">
                                    <img src="/thumbs/profile?id=<?= $selectedUser->id ?>&sxy=120&nocompress"
                                        alt="<?= htmlspecialchars($selectedUser->name, ENT_QUOTES, 'UTF-8') ?>"
                                        class="user-header-img">
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <h2 class="h3 fw-bold mb-1">
                                                    <?= htmlspecialchars($selectedUser->name, ENT_QUOTES, 'UTF-8') ?>
                                                </h2>
                                                <div class="small text-secondary mb-3">
                                                    <span class="badge bg-light text-dark border me-2">ID:
                                                        <?= $selectedUser->id ?></span>
                                        ...
                                        <div class="row g-3 small bg-light p-3 rounded-3">
                                            <div class="col-md-4">
                                                <div class="text-muted text-uppercase fw-bold mb-1"
                                                    style="font-size: 0.65rem;">Discord/Invite</div>
                                                <div class="text-dark">
                                                    <?= htmlspecialchars((string) ($userRow['user_discord'] ?? 'None'), ENT_QUOTES, 'UTF-8') ?>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="text-muted text-uppercase fw-bold mb-1"
                                                    style="font-size: 0.65rem;">Security Token</div>
                                                <code
                                                    class="text-primary"><?= htmlspecialchars($selectedUser->security_key, ENT_QUOTES, 'UTF-8') ?></code>
                                            </div>
                                                ...
                                                <form method="POST">
                                                    ...
                                                    <?php if ($selectedUser->IsAdmin()): ?>
                                                        ...
                                                        <button class="btn btn-sm btn-outline-danger fw-bold"
                                                            type="submit">Demote from Admin</button>
                                                    <?php else: ?>
                                                        <input type="hidden" name="action" value="promote_admin">
                                                        <button class="btn btn-sm btn-outline-primary fw-bold"
                                                            type="submit">Promote to Admin</button>
                                                    <?php endif; ?>
                                                </form>
                                            </div>
                                        </div>
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                <div class="card admin-card border-0 h-100" id="badge-tools">
                                    <div class="card-body p-4">
                                        <h3 class="h5 fw-bold mb-3 d-flex align-items-center"><i
                                                class="fas fa-award text-primary me-2"></i> Badges</h3>
                                        <form method="POST" class="d-grid gap-3">
                                            ...
                                            <select class="form-select border-0 bg-light" name="badge_id">
                                                <?php foreach (ANORRLBadge::cases() as $badge): ?>
                                                    <option value="<?= $badge->ordinal() ?>">
                                                        <?= htmlspecialchars($badge->name, ENT_QUOTES, 'UTF-8') ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="mt-4 badge-list d-flex flex-wrap gap-2">
                                            <?php foreach ($selectedUser->GetProfileBadges() as $badge): ?>
                                                <div class="badge-item d-inline-flex align-items-center gap-1">
                                                    <span
                                                        class="badge bg-primary-subtle text-primary border border-primary-subtle"><?= htmlspecialchars($badge->name, ENT_QUOTES, 'UTF-8') ?></span>
                                                    <form method="POST" class="d-inline"
                                                        ...
                                                        <input type="hidden" name="badge_id"
                                                            value="<?= $badge->id->ordinal() ?>">
                                                        <button type="submit"
                                                            class="btn btn-sm btn-link p-0 text-danger text-decoration-none"
                                                            title="Remove Badge"><i class="fas fa-times-circle"></i></button>
                                                    </form>
                                                </div>
                                            <?php endforeach; ?>
                            ...
                            <div class="col-md-6">
                                <div class="card admin-card border-0 h-100" id="warning-tools">
                                    <div class="card-body p-4">
                                        <h3 class="h5 fw-bold mb-3 d-flex align-items-center"><i
                                                class="fas fa-exclamation-triangle text-warning me-2"></i> Warning</h3>
                                        <form method="POST" class="d-grid gap-3">
                                            <input type="hidden" name="target_user_id" value="<?= $selectedUser->id ?>">
                                            <input type="hidden" name="action" value="warn_user">
                                            <textarea class="form-control border-0 bg-light" name="reason" rows="3"
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="mb-3 p-3 rounded-3 bg-light d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <div class="small text-muted fw-bold text-uppercase"
                                                    style="font-size:0.65rem;">Mevcut Bakiye</div>
                                                <div class="fw-bold fs-5"><?= number_format($selectedUser->GetZiu()) ?> ZIU
                                                </div>
                                            </div>
                                        </div>
                                        <form method="POST" class="d-flex gap-2">
                                            ...
                                            <input type="number" class="form-control border-0 bg-light" name="ziu_amount"
                                                placeholder="amount" min="-99999999999999999999" max="99999999999999999999"
                                                required>
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                <div class="card admin-card border-0 h-100" id="ban-tools">
                                    <div class="card-body p-4">
                                        <h3 class="h5 fw-bold mb-3 d-flex align-items-center"><i
                                                class="fas fa-gavel text-danger me-2"></i> Ban Control</h3>
                                        <form method="POST" class="d-grid gap-3 mb-3">
                                            <input type="hidden" name="target_user_id" value="<?= $selectedUser->id ?>">
                                            <input type="hidden" name="action" value="ban_user">
                                            <textarea class="form-control border-0 bg-light" name="reason" rows="3"
                                                placeholder="Reason for banishment..."></textarea>
                                        ...
                                        <?php if ($selectedUser->IsBanned()): ?>
                                            <form method="POST">
                                                ...
                                                <button class="btn btn-outline-dark w-100 fw-bold border-2" type="submit">Lift
                                                    Ban</button>
                                            </form>
                                        <?php endif; ?>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="card admin-card border-danger h-100">
                                    <div class="card-body p-4">
                                        <h3 class="h5 fw-bold mb-2 text-danger"><i class="fas fa-trash-alt me-2"></i> Danger
                                            Zone</h3>
                                        <p class="small text-muted mb-4">Deleting an account is permanent and removes all
                                            associated data. Use extreme caution.</p>
                                        <form method="POST"
                                            onsubmit="return confirm('ARE YOU SURE? This cannot be undone.');">
                                            <input type="hidden" name="target_user_id" value="<?= $selectedUser->id ?>">
                                            <input type="hidden" name="action" value="delete_user">
                                            <button class="btn btn-outline-danger w-100 fw-bold border-2"
                                                type="submit">Delete User Permanently</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 border-end">
                                                ...
                                                <?php else: ?>
                                                    <?php foreach ($warnings as $warning):
                                                        $warningAdmin = User::FromID(intval($warning['admin_id'])); ?>
                                                        <div
                                                            class="mb-3 p-3 bg-light rounded-3 shadow-sm border-start border-warning border-4">
                                                            <div class="d-flex justify-content-between mb-1">
                                                                <span
                                                                    class="fw-bold small"><?= htmlspecialchars($warningAdmin?->name ?? ('#' . $warning['admin_id']), ENT_QUOTES, 'UTF-8') ?></span>
                                                                <span
                                                                    class="text-muted smaller"><?= date('M j, Y H:i', strtotime($warning['created_at'])) ?></span>
                                                            </div>
                                                            <div class="small mb-2">
                                                                <?= htmlspecialchars($warning['reason'], ENT_QUOTES, 'UTF-8') ?>
                                                            </div>
                                                            <form method="POST" onsubmit="return confirm('Delete this warning?');">
                                                                ...
                                                                <input type="hidden" name="warning_id"
                                                                    value="<?= $warning['id'] ?>">
                                                                <button type="submit"
                                                                    class="btn btn-link p-0 text-danger text-decoration-none smaller fw-bold"
                                                                    style="font-size: 0.7rem;">Remove Warning</button>
                                                            </form>
                                                        </div>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            ...
                                            <div class="col-md-6 ps-4">
                                                ...
                                                <?php else:
                                                    $banAdmin = User::FromID(intval($banInfo['admin_id'])); ?>
                                                    <div
                                                        class="p-4 bg-danger-subtle text-danger rounded-3 shadow-sm border border-danger-subtle">
                                                        <div class="fw-bold mb-2">Banned by
                                                            <?= htmlspecialchars($banAdmin?->name ?? ('#' . $banInfo['admin_id']), ENT_QUOTES, 'UTF-8') ?>
                                                        </div>
                                                        <div class="small mb-3">
                                                            <?= htmlspecialchars($banInfo['reason'], ENT_QUOTES, 'UTF-8') ?>
                                                        </div>
                                                        <div class="smaller opacity-75">Banned on
                                                            <?= date('F j, Y, g:i a', strtotime($banInfo['created_at'])) ?>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
