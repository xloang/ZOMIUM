            ...
            <div class="col-lg-3">
                <div class="card admin-card border-0 mb-4">
                    <div class="card-body p-4">
                        <p class="header small fw-bold text-muted mb-3 text-uppercase">Find User</p>
                        <form method="GET" class="d-grid gap-3">
                            <div class="input-group">
                                <input class="form-control border-0 bg-light" type="text" name="q" value="<?= htmlspecialchars($q, ENT_QUOTES, 'UTF-8') ?>" placeholder="Name or ID...">
                ...
                <div class="card-body p-3">
                        <nav class="finobe-basic-nav">
                            <p class="header">TABS</p>
                            </a>
                        </nav>
                    </div>
                ...
                <div class="card admin-card border-0 mb-4">
                    <div class="card-body p-3">
                        <nav class="finobe-basic-nav">
                            <p class="header">Registration Feed</p>
                            <?php foreach ($recentUsers as $recentUser): ?>
                            <a class="link <?= ($selectedUser && $selectedUser->id == $recentUser->id) ? 'active' : '' ?>" href="/admi?user_id=<?= $recentUser->id ?>">
                                <?= htmlspecialchars($recentUser->name, ENT_QUOTES, 'UTF-8') ?>
                            </a>
                            <?php endforeach; ?>
                        </nav>
                    </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="card admin-card border-0 py-5 text-center">
                    <div class="card-body text-secondary">
                        ...
                        <p class="lead mb-0">Select a user to begin moderation.</p>
                    </div>
                </div>
                <?php else: ?>
