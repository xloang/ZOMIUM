<?php ob_start(); ?>
game:GetService("Players"):SetSaveDataUrl("http://zomium.xyz/Persistence/SetBlob.ashx?placeid={id}&userid=%d&access={access}")
game:GetService("Players"):SetLoadDataUrl("http://zomium.xyz/Persistence/GetBlob.ashx?placeid={id}&userid=%d&access={access}")
